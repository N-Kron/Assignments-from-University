 ...
 */
public class PlayerWinEqual implements WinStrategy {
   ...
   *         2. The dealer's score does not exceed the maximum score and is greater than the player's score.
   */
