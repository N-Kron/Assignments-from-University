...
4. Run the application using `./gradlew run -q --console=plain` - you should be prompted to enter your name and then your name should be printed, after that the application terminates.
